package com.my.retail.catalog.constants;

public class Constants {

    public static final String PROFILE_EXTERNAL_POSTGRES_DB = "EXTERNAL_POSTGRES_DB";
    ...
    public static final String CATALOG_DB_POOL_NAME = "catalog-hikari-pool";
